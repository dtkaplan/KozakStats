...
```{r sample-NHANES10-resample-histogram, warning=FALSE, echo=FALSE, fig.cap="(ref:sample-NHANES10-resample-histogram-cap)"}
...
gf_histogram( ~ mea, data = Trials_resample, bins = 10) %>%
  gf_lims(x = c(-5, 10)) %>%
...
```{r tdistribution-graph, echo=FALSE, fig.cap="(ref:tdistribution-graph-cap)"}
...
```{r sample-NHANES-50-density, warning=FALSE, fig.cap="(ref:sample-NHANES-50-density-cap)"}
gf_density(~BMI, data=sample_NHANES_50)
```

(ref:sample-NHANES-50-qq-cap) Normal Quantile Plot of BMI from NHANES sample

```{r sample-HNANES-50-qq, warning=FALSE, fig.cap="(ref:sample-NHANES-50-qq-cap)"}
...
```{r, expectancy-male-density, fig.cap="(ref:expanctancy-male-density-cap)"}
...
```{r, expanctancy-male-qq, fig.cap="(ref:expanctancy-male-qq-cap)"}
