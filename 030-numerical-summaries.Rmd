...
```{r cats5-data}
head(cats) #This command shows the variable names and the first few unit of observation rows
```
...
![Graphs of symmetric, skewed right and skewed left](centers_distribution.png)
...
![Graphs of symmetric, skewed right and skewed left](graph_3_1_1.png)
...
![Graphs of symmetric, skewed right and skewed left](graph_3_1_2.png)
...
```{r cats1-data-box, fig.cap="(ref:cats1-data-box-cap)"}
...
```{r cats2-data-box, fig.cap="(ref:cats2-data-box-cap)"}
...
(ref:density-data-density-cap) Density Plot of Health Expenditure

```{r density-data-density, fig.cap="(ref:density-data-density-cap)"}
gf_density(~time, data=Nerve)
```
...
```{r nerve-data-box, fig.cap="(ref:nerve-data-box-cap)", include=FALSE}
gf_boxplot(~time, data=Nerve)
```
