...
```{r NHANES6-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6-density-cap)"}
...
```{r headcirc6-density, warning=FALSE, echo=FALSE, fig.cap="(ref:headcirc6-density=cap)"}
...
```{r NHANES6a-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6a-density-cap)"}
...
```{r NHANES6b-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6b-density-cap)"}
...
```{r NHANES6c-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6c-density-cap)"}
...
```{r normal-curveb, echo=FALSE, fig.cap="(ref:normal-curveb-cap)"}
...
```{r normal-curve61, echo=FALSE, fig.cap="(ref:normal-curve61-cap)"}
...
```{r normal-curve62, echo=FALSE, fig.cap="(ref:normal-curve62-cap)"}
...
```{r normal-curve63, echo=FALSE, fig.cap="(ref:normal-curve63-cap)"}
...
```{r normal-curve-preg, echo=FALSE, fig.cap="(ref:normal-curve-preg-cap)"}
...
```{r normal-curve-preg1, echo=FALSE, fig.cap="(ref:normal-curve-preg1-cap)"}
...
```{r normal-curve-SAT, echo=FALSE, fig.cap="(ref:normal-curve-SAT-cap)"}
...
```{r normal-curve-SAT1, echo=FALSE, fig.cap="(ref:normal-curve-SAT1-cap)"}
...
```{r normal-curve-SAT2, echo=FALSE, fig.cap="(ref:normal-curve-SAT2-cap)"}
...
```{r blowhole-density, fig.cap="(ref:blowhole-density-cap)"}
...
```{r blowhole-qq, fig.cap="(ref:blowhole-qq-cap)"}
...
```{r pulse-density, warning=FALSE, fig.cap="(ref:pulse-density-cap)"}
...
```{r pulse-qq, warning=FALSE, fig.cap="(ref:pulse-qq-cap)"}
...
```{r NHANES6h-density, echo=FALSE, warning=FALSE, fig.cap="(ref:NHANES6h-density-cap)"}
gf_density(~Pulse, data=NHANES)
...
```{r NHANES6e-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6e-density-cap)"}
Trials <- 
  do(100) * {
    NHANES %>%
      sample_n(size = 10) %>%
...
```{r NHANES6f-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6f-density-cap)"}
Trials <- 
  do(100) * {
    NHANES %>%
      sample_n(size = 50) %>%
...
```{r NHANES6g-density, echo=FALSE, warning=FALSE, fig.cap="(ref:NHANES6g-density-cap)"}
gf_density(~SmokeAge, data=NHANES)
...
```{r NHANES6-random, warning=FALSE, echo=FALSE}
Trials <- 
  do(100) * {
    NHANES %>%
      sample_n(size = 50) %>%
