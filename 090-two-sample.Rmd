...
```{r pulse9-female-density, echo=FALSE, fig.cap="(ref:pulse9-female-density-cap)", warning=FALSE}
gf_density(~difference, data=Pulse_female_new)
```


(ref:pulse9-female-qq-cap) Normal Quantile Plot of Differences in Weights

```{r pulse9-female-qq, warning=FALSE, echo=FALSE, fig.cap="(ref:pulse9-female-qq-cap)"}
...
```{r helmet9-new-denstiy, fig.cap="(ref:helmet9-new-density-cap)"}
gf_density(~difference, data=Helmet_new)
```

(ref:helmet9-new-qq-cap) Normal Quantile Plot of Differences in Head Measurements

```{r helmet9-new-qq, fig.cap="(ref:helmet9-new-qq-cap)"}
gf_qq(~difference, data=Helmet_new)
```
...
```{r NHANES9-diabetes-density, warning=FALSE, fig.cap="(ref:NHANES9-diabetes-density-cap)"}
gf_density(~TotChol|Diabetes, data=NHANES)
```
...
```{r NHANES9-diabetes-qq, warning=FALSE, fig.cap="(ref:NHANES9-diabetes-qq-cap)"}
gf_qq(~TotChol|Diabetes, data=NHANES)
```
...
(ref:hotdog9-desnity-cap) Density Plot of Sodium Levels in Hotdogs

```{r hotdog9-density, fig.cap="(ref:hotdog9-desnity-cap)"}
...
```{r hotdog9-qq, fig.cap="(ref:hotdog9-qq-cap)"}
